...
class Gen1 extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
   return Scaffold(
    body : ListView(children: new List.generate(pokemons.length, (index) => new ListTile(title : Text('Nome: '+pokemons[index].name+'\n'+'Id: '+pokemons[index].id.toString()), leading: Image.network('https://pokeres.bastionbot.org/images/pokemon/${index+1}.png'),)))
   );
